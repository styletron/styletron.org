...
CSS in JS is not just about "throwing" some CSS into `.js` files. **CSS in JS comes with a different philosophy**. You can still use the most of CSS constructs but there are some quirks and limitations and a different approach is needed. Those restrictions are not necessarly bad but can be certainly frustrating if you are new to this. This page should answer most of your "_How to do x in Styletron_" questions and describe some best practices.

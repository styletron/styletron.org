...
<Notification>If you use styletron-engine-monolithic, this restriction does not apply to you, you can mix longhand and shorthand properties.</Notification>
...
<Notification>If you use styletron-engine-monolithic, this restriction does not apply to you, the order is always respected.</Notification>

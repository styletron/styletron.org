...
[Fusion.js](https://fusionjs.com/) is a a plugin-based universal web framework. Your application might already support Styletron! Check if [fusion-plugin-styletron-react](https://github.com/fusionjs/fusion-plugin-styletron-react) has been installed. If not, run
...
Then you can directly import `styled` function:
